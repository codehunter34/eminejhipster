...
public class EminejhipsterApp {

    private static final Logger log = LoggerFactory.getLogger(EminejhipsterApp.class);

    private final Environment env;

    public EminejhipsterApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes eminejhipster.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(EminejhipsterApp.class);
